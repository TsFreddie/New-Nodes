...
container.sounds.Add(SoundSet("build", FileList("audio/sfx_build-%02d.wv", 4)))
container.sounds.Add(SoundSet("teleport", ["audio/sfx_teleport.wv"]))

container.sounds.Add(SoundSet("crate_impact", FileList("audio/crt_impact-%02d.wv", 3)))
container.sounds.Add(SoundSet("crate_spawn", FileList("audio/crt_spawn-%02d.wv", 3)))

container.sounds.Add(SoundSet("crate_emp", FileList("audio/emp_explo-%02d.wv", 2)))
container.sounds.Add(SoundSet("buff_ticking", ["audio/crt_bomb_ticking.wv"]))

container.sounds.Add(SoundSet("reactor", ["audio/nds_reactor.wv"]))
container.sounds.Add(SoundSet("crate_ice", ["audio/crt_ice-01.wv"]))
...
image_buildmenu = Image("buildmenu", "buildmenu.png")
image_turrets = Image("turrets", "buildings/turrets.png")
image_nopower = Image("nopower", "no_energy.png")
image_blocks = Image("blocks", "blocks.png")

#image_buffs = Image("buffs", "buffs.png")
image_fx_ice = Image("fx_ice", "fx_ice.png")
image_fx_ice_expl = Image("fx_ice_expl", "fx_ice_explosion.png")
image_fx_bomb = Image("fx_bomb", "fx_bomb.png")
image_fx_hot = Image("fx_hot", "fx_hot.png")

image_gui = Image("gui", "gui_x2.png")

image_crate = Image("crate", "fx_crate.png")
image_helmets = Image("helmets", "fx_helmets.png")
#image_buildings_red = Image("buildings_red", "buildings_red.png")
#image_buildings_blue = Image("buildings_blue", "buildings_blue.png")
...
#Nodes Container 1
container.images.Add(image_buildmenu)
...
#container.images.Add(image_buffs)
container.images.Add(image_fx_ice)
container.images.Add(image_fx_ice_expl)
container.images.Add(image_fx_bomb)
container.images.Add(image_fx_hot)
container.images.Add(image_gui)
container.images.Add(image_crate)
container.images.Add(image_turrets)
container.images.Add(image_nopower)
container.images.Add(image_blocks)
container.images.Add(image_helmets)

#container.images.Add(image_buildings_red)
#container.images.Add(image_buildings_blue)

#Nodes Containers End
...
set_game = SpriteSet("game", image_game, 32, 18)
...
set_buildmenu = SpriteSet("buildmenu", image_buildmenu, 4, 4)
set_turrets = SpriteSet("turrets", image_turrets, 14, 4)
set_nopower = SpriteSet("nopower", image_nopower, 1, 2)
set_blocks = SpriteSet("blocks", image_blocks, 6, 3)
#set_buffs = SpriteSet("buffs", image_buffs, 12, 4)
set_fx_ice = SpriteSet("fx_ice", image_fx_ice, 2, 1)
set_fx_ice_expl = SpriteSet("fx_ice_expl", image_fx_ice_expl, 1, 1)
set_fx_bomb = SpriteSet("fx_bomb", image_fx_bomb, 4, 1)
set_fx_hot = SpriteSet("fx_hot", image_fx_hot, 12, 1)

set_gui = SpriteSet("gui", image_gui, 6, 5)
set_crate = SpriteSet("crate", image_crate, 7, 4)
set_helmets = SpriteSet("helmets", image_helmets, 4, 1)
#set_buildings_red = SpriteSet("buildings_red", image_buildings_red, 60, 98)
#set_buildings_blue = SpriteSet("buildings_blue", image_buildings_blue, 60, 98)
...
container.spritesets.Add(set_buildmenu)
container.spritesets.Add(set_turrets)
container.spritesets.Add(set_nopower)
container.spritesets.Add(set_blocks)
container.spritesets.Add(set_fx_ice)
container.spritesets.Add(set_fx_ice_expl)
container.spritesets.Add(set_fx_bomb)
container.spritesets.Add(set_fx_hot)
container.spritesets.Add(set_gui)
container.spritesets.Add(set_crate)
container.spritesets.Add(set_helmets)
#container.spritesets.Add(set_buildings_red)
#container.spritesets.Add(set_buildings_blue)
...
#container.sprites.Add(Sprite("health_full_start", set_game, 20,10,2,2))
#container.sprites.Add(Sprite("health_full_end", set_game, 22,10,2,2))
#container.sprites.Add(Sprite("health_empty_start", set_game, 20,8,2,2))
#container.sprites.Add(Sprite("health_empty_end", set_game, 22,8,2,2))

#container.sprites.Add(Sprite("armor_full_start", set_game, 20,12,2,2))
#container.sprites.Add(Sprite("armor_full_end", set_game, 22,12,2,2))
#container.sprites.Add(Sprite("armor_empty_start", set_game, 20,8,2,2))
#container.sprites.Add(Sprite("armor_empty_end", set_game, 22,8,2,2))
...
container.sprites.Add(Sprite("weapon_baseball", set_game, 2,15,5,2))
container.sprites.Add(Sprite("weapon_baseball_cursor", set_game, 0,15,2,2))
...
container.sprites.Add(Sprite("e_reactor", set_buildmenu, 0, 0, 1, 1))
container.sprites.Add(Sprite("e_spawn", set_buildmenu, 1, 0, 1, 1))
container.sprites.Add(Sprite("e_ammo1", set_buildmenu, 2, 0, 1, 1))
container.sprites.Add(Sprite("e_turret1", set_buildmenu, 3, 0, 1, 1))
container.sprites.Add(Sprite("e_repeater", set_buildmenu, 0, 1, 1, 1))
container.sprites.Add(Sprite("e_health", set_buildmenu, 1, 1, 1, 1))
container.sprites.Add(Sprite("e_shield", set_buildmenu, 2, 1, 1, 1))
container.sprites.Add(Sprite("e_ammo", set_buildmenu, 3, 1, 1, 1))
container.sprites.Add(Sprite("e_teleport", set_buildmenu, 0, 2, 1, 1))
container.sprites.Add(Sprite("e_armor", set_buildmenu, 1, 2, 1, 1))
container.sprites.Add(Sprite("e_ammo3", set_buildmenu, 2, 2, 1, 1))
container.sprites.Add(Sprite("e_turret2", set_buildmenu, 3, 2, 1, 1))
...
for i in range(0, 2):
	container.sprites.Add(Sprite("fx_ice_"+str(i), set_fx_ice, i,0,1,1))

container.sprites.Add(Sprite("fx_ice_expl", set_fx_ice_expl, 0,0,1,1))

for i in range(0, 12):
	container.sprites.Add(Sprite("fx_hot_"+str(i), set_fx_hot, i,0,1,1))
	
for i in range(0, 4):
	container.sprites.Add(Sprite("fx_bomb_"+str(i), set_fx_bomb, i,0,1,1))


	
#container.sprites.Add(Sprite("buff_ice_1", set_buffs, 0, 3, 1, 1));

container.sprites.Add(Sprite("gui_health_start", set_gui, 0, 0, 1, 1));
container.sprites.Add(Sprite("gui_health", set_gui, 1, 0, 1, 1));
container.sprites.Add(Sprite("gui_health_end", set_gui, 2, 0, 1, 1));

container.sprites.Add(Sprite("gui_armor_start", set_gui, 0, 1, 1, 1));
container.sprites.Add(Sprite("gui_armor", set_gui, 1, 1, 1, 1));
container.sprites.Add(Sprite("gui_armor_end", set_gui, 2, 1, 1, 1));

container.sprites.Add(Sprite("gui_empty_start", set_gui, 0, 2, 1, 1));
container.sprites.Add(Sprite("gui_empty", set_gui, 1, 2, 1, 1));
container.sprites.Add(Sprite("gui_empty_end", set_gui, 2, 2, 1, 1));

container.sprites.Add(Sprite("gui_rage", set_gui, 3, 0, 3, 3));
container.sprites.Add(Sprite("gui_rage_hot", set_gui, 0, 3, 2, 2));
container.sprites.Add(Sprite("gui_rage_bomb", set_gui, 2, 3, 2, 2));
container.sprites.Add(Sprite("gui_rage_rampage", set_gui, 4, 3, 2, 2));

container.sprites.Add(Sprite("crate1", set_crate, 0,0,2,4))
container.sprites.Add(Sprite("crate2", set_crate, 2,0,2,4))
container.sprites.Add(Sprite("parachute", set_crate, 4,0,3,3))

container.sprites.Add(Sprite("helmet_construction", set_helmets, 0,0,1,1));
container.sprites.Add(Sprite("helmet_baseball", set_helmets, 1,0,1,1));
container.sprites.Add(Sprite("helmet_soldier", set_helmets, 2,0,1,1));
container.sprites.Add(Sprite("helmet_bandana", set_helmets, 3,0,1,1));
...
bteamnames = ["red", "blue"]
#bsets = [set_buildings_red, set_buildings_blue]

by = 0
for i in range(0, len(buildings)):
	b_width = buildings[i][1]*2;
	b_height = buildings[i][2]*2;
	b_frames = buildings[i][3];
	b_set = [0, 0]
	for t in range(0,2):
		b_name = "building_"+buildings[i][0]+"_"+bteamnames[t];
		b_filename = "buildings/"+bteamnames[t] + "_" + buildings[i][0] + ".png";
		b_img = Image(b_name, b_filename);
		container.images.Add(b_img)
		b_set[t] = SpriteSet(b_name, b_img, b_width*b_frames, b_height)
		container.spritesets.Add(b_set[t])
#		print("image "+b_name+", width "+str(b_width*b_frames)+", height "+str(b_height))
		
		
	for j in range(1,b_frames+1):
		for t in range(0,2):
			b_name = "building_"+buildings[i][0]+"_"+bteamnames[t]+("" if j==1 else "_"+str(j));
			container.sprites.Add(Sprite(b_name, b_set[t], b_width*(j-1), 0, b_width, b_height))
			#print("adding "+b_name+" at "+str(b_width*(j-1))+", width "+str(b_width)+", height "+str(b_height))
	
		
"""
	bx = 0
	for j in range(1,buildings[i][-1]+1):
		for t in range(0,2):
			print("adding "+"building_"+buildings[i][0]+ "_" +bteamnames[t] + ("" if j==1 else "_"+str(j))+" at "+str(bx)+":"+str(by))
			container.sprites.Add(Sprite("building_"+buildings[i][0]+"_"+ bteamnames[t] + ("" if j==1 else "_"+str(j)), bsets[t], bx, by, buildings[i][1]*2, buildings[i][2]*2))
		bx += buildings[i][1]*2
	by += buildings[i][2]*2+2
	"""
"""

container.sprites.Add(Sprite("building_reactor_red", set_buildings, 0,20,8,10))
container.sprites.Add(Sprite("building_reactor_blue", set_buildings, 8,20,8,10))
container.sprites.Add(Sprite("building_spawn_red", set_buildings, 16,22,6,8))
container.sprites.Add(Sprite("building_spawn_blue", set_buildings, 22,22,6,8))
container.sprites.Add(Sprite("building_ammo1_red", set_buildings, 0,14,4,4))
container.sprites.Add(Sprite("building_ammo1_red_1", set_buildings, 28,20,4,4))
container.sprites.Add(Sprite("building_ammo1_red_2", set_buildings, 32,20,4,4))
container.sprites.Add(Sprite("building_ammo1_red_3", set_buildings, 36,20,4,4))
container.sprites.Add(Sprite("building_ammo1_blue", set_buildings, 4,14,4,4))
container.sprites.Add(Sprite("building_turret1_red", set_buildings, 0,6,6,6))
container.sprites.Add(Sprite("building_turret1_blue", set_buildings, 6,6,6,6))


container.sprites.Add(Sprite("building_repeater_red", set_buildings, 36,6,4,6))
container.sprites.Add(Sprite("building_repeater_blue", set_buildings, 40,6,4,6))
container.sprites.Add(Sprite("building_health_red", set_buildings, 24,14,4,4))
container.sprites.Add(Sprite("building_health_blue", set_buildings, 28,14,4,4))
container.sprites.Add(Sprite("building_shield_red", set_buildings, 24,6,6,6))
container.sprites.Add(Sprite("building_shield_blue", set_buildings, 30,6,6,6))
container.sprites.Add(Sprite("building_ammo2_red", set_buildings, 8,14,4,4))
container.sprites.Add(Sprite("building_ammo2_blue", set_buildings, 12,14,4,4))

container.sprites.Add(Sprite("building_teleport_red", set_buildings, 28,26,6,4))
container.sprites.Add(Sprite("building_teleport_blue", set_buildings, 34,26,6,4))
container.sprites.Add(Sprite("building_armor_red", set_buildings, 32,14,4,4))
container.sprites.Add(Sprite("building_armor_blue", set_buildings, 36,14,4,4))
container.sprites.Add(Sprite("building_ammo3_red", set_buildings, 16,14,4,4))
container.sprites.Add(Sprite("building_ammo3_blue", set_buildings, 20,14,4,4))
container.sprites.Add(Sprite("building_turret2_red", set_buildings, 12,6,6,6))
container.sprites.Add(Sprite("building_turret2_blue", set_buildings, 18,6,6,6))
"""
container.sprites.Add(Sprite("turret1_head", set_turrets, 0,0,7,4))
container.sprites.Add(Sprite("turret2_head", set_turrets, 7,0,7,4))
container.sprites.Add(Sprite("nopower", set_nopower, 0,0,1,2))

container.sprites.Add(Sprite("block_red_2", set_blocks, 0,0,1,1))
container.sprites.Add(Sprite("block_red_3", set_blocks, 1,0,1,1))
container.sprites.Add(Sprite("block_blue_2", set_blocks, 2,0,1,1))
container.sprites.Add(Sprite("block_blue_3", set_blocks, 3,0,1,1))
container.sprites.Add(Sprite("block_white_2", set_blocks, 4,0,1,1))
container.sprites.Add(Sprite("block_white_3", set_blocks, 5,0,1,1))

container.sprites.Add(Sprite("block_red_2_app", set_blocks, 0,1,1,1))
container.sprites.Add(Sprite("block_red_3_app", set_blocks, 1,1,1,1))
container.sprites.Add(Sprite("block_blue_2_app", set_blocks, 2,1,1,1))
container.sprites.Add(Sprite("block_blue_3_app", set_blocks, 3,1,1,1))
container.sprites.Add(Sprite("block_white_2_app", set_blocks, 4,1,1,1))
container.sprites.Add(Sprite("block_white_3_app", set_blocks, 5,1,1,1))

container.sprites.Add(Sprite("block_red_2_emp", set_blocks, 0,2,1,1))
container.sprites.Add(Sprite("block_red_3_emp", set_blocks, 1,2,1,1))
container.sprites.Add(Sprite("block_blue_2_emp", set_blocks, 2,2,1,1))
container.sprites.Add(Sprite("block_blue_3_emp", set_blocks, 3,2,1,1))
container.sprites.Add(Sprite("block_white_2_emp", set_blocks, 4,2,1,1))
container.sprites.Add(Sprite("block_white_3_emp", set_blocks, 5,2,1,1))

#container.sprites.Add(Sprite("building_door_red_2", set_buildings, 34,0,4,4))
#container.sprites.Add(Sprite("building_door_white_3", set_buildings, 38,0,4,4))
