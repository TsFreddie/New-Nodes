...
Buildings = ["REACTOR", "SPAWN", "AMMO1", "HEALTH", "REPEATER", "TURRET1", "SHIELD", "AMMO2", "TELEPORT", "ARMOR", "AMMO3", "TURRET2", "SHIELDHIT"]
...
Objects = [
	...
	NetObject("CharacterCore", [
		...
		NetIntRange("m_Effect", 0, 1),
		NetTick("m_RampageTick"),
	...
	NetObject("Character:CharacterCore", [
		...
		NetIntRange("m_Rage", 0, 100),
		
		NetIntAny("m_Crate"),
		NetIntAny("m_CrateMisc"),
		NetTick("m_CrateTick"),
	]),
	...
	NetEvent("PositionUpdate:Common", []),
	NetEvent("Wrench:Common", []),
	#NetEvent("Fallout:Common", []),
	NetEvent("Effect:Common", [
		NetIntRange("m_EffectID", 0, 4),
	]),
]
...
Messages = [
	...
	NetMessage("Sv_KillMsg", [
		NetIntRange("m_Killer", -4, 'MAX_CLIENTS-1'),
		NetIntRange("m_Victim", -12, 'MAX_CLIENTS-1'),
		NetIntRange("m_Weapon", -4, 'NUM_WEAPONS-1'),
	...
	NetMessage("Cl_Building", [
		NetIntRange("m_Building", 0, 'NUM_BUILDINGS-1'),
	]),
