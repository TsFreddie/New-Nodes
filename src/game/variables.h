...
//Nodes Config
MACRO_CONFIG_INT(ClQuickHelp, cl_quickhelp, 1, 0, 1, CFGFLAG_CLIENT|CFGFLAG_SAVE, "Show quickhelp")
...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "nodes", CFGFLAG_SERVER, "Game type (dm, tdm, ctf)")
...
// debug
	...
	MACRO_CONFIG_INT(DbgDummies, dbg_dummies, 0, 0, 63, CFGFLAG_SERVER, "")
#endif

// Nodes Config
MACRO_CONFIG_INT(SvBuildPoints, sv_buildpoints, 200, 0, 1000000, CFGFLAG_SERVER, "Build points")
MACRO_CONFIG_INT(SvBuildingsFf, sv_buildings_ff, 1, 0, 1, CFGFLAG_SERVER, "Friendly fire on buildings")
MACRO_CONFIG_INT(SvBuildDelay, sv_builddelay, 10, 0, 1000000, CFGFLAG_SERVER, "Time delay before being able to build again")
MACRO_CONFIG_INT(SvEmpDuration, sv_emp_duration, 5, 0, 1000000, CFGFLAG_SERVER, "Duration of the EMP effect")
MACRO_CONFIG_INT(SvCrateProbability, sv_crate_probability, 50, 0, 1000, CFGFLAG_SERVER, "Probability per second in permil that a crate is created")
MACRO_CONFIG_INT(SvRageModifier, sv_rage_modifier, 1, 0, 100, CFGFLAG_SERVER, "Rage points per hit")
MACRO_CONFIG_INT(SvKillDelay, sv_kill_delay, 30, 0, 100000, CFGFLAG_SERVER, "Time delay for commiting suicide")
MACRO_CONFIG_INT(SvFreezeRadius, sv_freeze_radius, 200, 0, 100000, CFGFLAG_SERVER, "Radius of the freeze effect")
