...
void CCharacterCore::Tick(bool UseInput)
{
	...
	else if(m_HookState == HOOK_FLYING)
	{
		...
		if(Hit)
		{
			if(m_pCollision->IsTileNohook(Hit))
				GoingToRetract = true;
			else
...
void CCharacterCore::Write(CNetObj_CharacterCore *pObjCore)
{
	...
	pObjCore->m_Effect = m_Effect;
	pObjCore->m_Frozen = m_Frozen;
	pObjCore->m_Nograv = m_Nograv;
...
void CCharacterCore::Read(const CNetObj_CharacterCore *pObjCore)
{
	...
	m_Effect = pObjCore->m_Effect;
	m_Frozen = pObjCore->m_Frozen;
	//m_Nograv = pObjCore->m_Nograv;
