...
MACRO_CONFIG_STR(PlayerName, player_name, 16, "Nodes Player", CFGFLAG_SAVE|CFGFLAG_CLIENT, "Name of the player")
...
MACRO_CONFIG_STR(SvName, sv_name, 128, "A New Nodes Server", CFGFLAG_SERVER, "Server name")
...
MACRO_CONFIG_STR(SvMap, sv_map, 128, "hill", CFGFLAG_SERVER, "Map to use on the server")
