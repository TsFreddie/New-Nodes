...
void CClient::RegisterCommands()
{
	...
	m_pConsole->Register("quit", "", CFGFLAG_CLIENT|CFGFLAG_STORE, Con_Quit, this, "Quit Nodes");
	m_pConsole->Register("exit", "", CFGFLAG_CLIENT|CFGFLAG_STORE, Con_Quit, this, "Quit Nodes");
	m_pConsole->Register("minimize", "", CFGFLAG_CLIENT|CFGFLAG_STORE, Con_Minimize, this, "Minimize Nodes");
...
int main(int argc, const char **argv) // ignore_convention
{
	...
	IEngine *pEngine = CreateEngine("Nodes");
	IConsole *pConsole = CreateConsole(CFGFLAG_CLIENT);
	IStorage *pStorage = CreateStorage("Nodes", IStorage::STORAGETYPE_CLIENT, argc, argv); // ignore_convention
